...
const I18N_MESSAGES = {
  es: {
    'meta.title': 'Aprender y practicar ZBLL 3x3 | ZBLL Trainer',
    'meta.description': 'Aprende y practica ZBLL en cubo 3x3 gratis. Modo Aprender, modo Practicar, 472 casos ZBLL, cronómetro, estadísticas y uso offline.',
    ...
    'seo.title': 'Aprender ZBLL y practicar ZBLL en cubo 3x3',
    'seo.p1': 'ZBLL Trainer es la web gratuita para aprender ZBLL y practicar ZBLL en 3x3. Incluye los 472 casos, modo Aprender, modo Practicar, mezclas cómodas y estadísticas por caso.',
    'seo.h3Learn': 'Aprender ZBLL: modo estudio',
    'seo.pLearn': 'El modo Aprender te muestra la mezcla, tu algoritmo y los algoritmos oficiales de cada caso ZBLL para memorizar y repasar sin presión de tiempo.',
    'seo.h3Practice': 'Practicar ZBLL con cronómetro',
    'seo.pPractice': 'El modo Practicar lanza scrambles filtrados, cronómetro instantáneo y repeticiones de casos flojos para entrenar ZBLL de forma continua desde móvil o escritorio, incluso sin conexión.',
    'seo.p2': 'Si buscas aprender ZBLL o practicar ZBLL con una app rápida y sin registro, ZBLL Trainer está pensada para ti.',
  ...
  en: {
    'meta.title': 'Learn and practice ZBLL 3x3 | ZBLL Trainer',
    'meta.description': 'Learn and practice ZBLL on 3x3 for free. Study mode, practice mode, 472 ZBLL cases, timer, statistics and offline support.',
    ...
    'seo.title': 'Learn ZBLL and practice ZBLL on 3x3',
    'seo.p1': 'ZBLL Trainer is the free web app to learn ZBLL and practice ZBLL on 3x3. It includes all 472 cases, Study mode, Practice mode, comfortable scrambles and per-case statistics.',
    'seo.h3Learn': 'Learn ZBLL: study mode',
    'seo.pLearn': 'Study mode shows the scramble, your algorithm and official algorithms for each ZBLL case so you can memorize and review without time pressure.',
    'seo.h3Practice': 'Practice ZBLL with a timer',
    'seo.pPractice': 'Practice mode serves filtered scrambles, an instant timer and repeats for weak cases so you can train ZBLL continuously on mobile or desktop, even offline.',
    'seo.p2': 'If you want to learn ZBLL or practice ZBLL with a fast app and no sign-up, ZBLL Trainer is built for you.',
